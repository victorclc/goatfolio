...
import 'package:goatfolio/pages/portfolio/donut_chart.dart';
...
import 'package:goatfolio/widgets/cupertino_sliver_page.dart';
...
import 'investment_type_expansion_tile.dart';
                  ...
                  children: [
                    ...
                    if (cubit.portfolioPerformance!.hasStocks)
                      InvestmentTypeExpansionTile(
                        title: 'Ações/ETFs',
                        grossAmount: cubit
                            .portfolioPerformance!.stockSummary!.grossValue,
                        items: cubit.portfolioPerformance!.stockSummary!
                            .openedPositions,
                        colors: colors,
                    ...
                    if (cubit.portfolioPerformance!.hasBdrs)
                      InvestmentTypeExpansionTile(
                        title: 'BDRs',
                        grossAmount:
                            cubit.portfolioPerformance!.bdrSummary!.grossValue,
                        items: cubit
                            .portfolioPerformance!.bdrSummary!.openedPositions,
                        colors: colors,
                        totalAmount: cubit.portfolioPerformance!.grossValue,
                      ),
                    if (cubit.portfolioPerformance!.hasReits)
                      InvestmentTypeExpansionTile(
                        title: 'FIIs',
                        grossAmount:
                            cubit.portfolioPerformance!.reitSummary!.grossValue,
                        items: cubit
                            .portfolioPerformance!.reitSummary!.openedPositions,
                        colors: colors,
                        totalAmount: cubit.portfolioPerformance!.grossValue,
                      ),
                  ],
