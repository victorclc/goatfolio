...
class TestCEICore(unittest.TestCase):
    ...
    def test_not_successful_import_result_should_update_the_status_and_payload_and_error_message_on_database(self):
        import_result = CEIImportResult(subject='1111-2222-333-4444', datetime=123, status=ImportStatus.ERROR,
