...
def accept_friend_request(from_user: User,
                          to_user: User,
                          publisher: FriendRequestPublisher):
    to_request = FriendRequest(from_user, to_user, RequestType.ACCEPT_TO)
    from_request = FriendRequest(from_user, to_user, RequestType.ACCEPT_FROM)
