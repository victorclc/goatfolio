...
class TestPortfolioCore(unittest.TestCase):
    ...
    #
    #     self.core.consolidate_investments(self.subject, [self.BUY_INVESTMENT], [])
    #
    #     portfolio = self.core.repo.save.call_args_list[0].args[0]
    #
    #     self.assertEqual(self.core.repo.save.call_count, 1)
    #
    #     self.assertEqual(
