...
if __name__ == '__main__':
    line = "012021112608OIBR3       010OI          ON      N1   R$  000000000008800000000000890000000000085000000000008700000000000880000000000087000000000008811890000000000071720500000000006262102500000000000000009999123100000010000000000000BROIBRACNOR1108"
    instance = B3CotaHistData()
    instance.load_line(line)
    print(instance)
